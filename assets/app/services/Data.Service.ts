...
@Injectable()
export class DatasService implements SailsService, MessageInterface, StoreInterface {

    _name: string;

    private socket: any;
    public data$: Observable<any[]>;
    //private socket = io("https://surecheckapi.herokuapp.com");
    ...
    subscribe() {
        this.socket.on(this._name, function(data){
            console.log(data);
        });
        return;
    }
